...
const { score_sound, die, start, hit, flap } = audios;

import image from "./assets/image/sprite.png";
...
var SCORE = new Audio(score_sound);

var DIE = new Audio(die);

var START = new Audio(start);

var HIT = new Audio(hit);

var FLAP = new Audio(flap);
